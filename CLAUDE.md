...
- Money: `computePayroll` rounds once, to cents, at the end. Weeks are Sunday–Saturday everywhere (Timeproof convention). Work logs upsert on (person, date); the source is informational.
